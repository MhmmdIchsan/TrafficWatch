...
export default function Admin() {
  ...
  const fetchDevices = useCallback(async () => {
    try {
      const response = await fetch('https://iicgias063.execute-api.ap-southeast-3.amazonaws.com/bledemo/locationinfo');
  ...
  const fetchDeviceDetails = async (deviceId: string): Promise<Device | null> => {
    ...
    const url = `https://iicgias063.execute-api.ap-southeast-3.amazonaws.com/bledemo/devices?deviceid=${deviceId}&start_time=${formatTimestamp(startTime)}&end_time=${formatTimestamp(endTime)}`;
